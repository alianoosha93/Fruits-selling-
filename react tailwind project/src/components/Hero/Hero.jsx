  ...
  return (
    <section>
      <div className="container grid grid-cols-1 md:grid-cols-2 min-h-[600px] relative"> 
        {/* Brand Info */}
        <div className='flex flex-col justify-center py-14 md:py-0 relative z-9 '>
            <div className='text-center md:text-left space-y-6 lg:max-w-[400px]'>
                ...
                initial = "hidden"
                animate = "visible"
                className='text-gray-500'>Healthy and yummy food for fresh morning breakfast. Eat Daily for good health and mind Order now and get 20% off on your first orde</motion.p>
                {/* Button Section */}
                <motion.div
